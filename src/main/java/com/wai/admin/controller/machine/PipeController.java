...
import com.wai.admin.service.machine.PipeService;
...
public class PipeController {
    ...
    public ResponseEntity<Map<String, Object>> getCommonCodes(@RequestBody Map<String, Object> searchParams) {
        ...
        result = pipeService.getCommonCodes(searchParams);
    ...
    public ResponseEntity<Map<String, Object>> getCommonDepthCode(@PathVariable String search_value) {
        ...
        result = pipeService.getCommonDepthCode(search_value);
    ...
    public ResponseEntity<Map<String, Object>> getDepth(@RequestBody Map<String, Object> searchParams) {
        Map<String, Object> result = pipeService.getDepth(searchParams);
    ...
    public ResponseEntity<Map<String, Object>> getDepthDetail(@RequestBody Map<String, Object> searchParams) {
        Map<String, Object> result = pipeService.getDepthDetail(searchParams);
    ...
    public ResponseEntity<Map<String, Object>> getDepthDetailSearchType(@PathVariable String search_key) {
        Map<String, Object> result = pipeService.getDepthDetailSearchType(search_key);
    ...
    public ResponseEntity<Map<String, Object>> getSearchList(
        ...
        result = pipeService.getPipeList(searchParams, waiLang);
    ...
    public ResponseEntity<Map<String, Object>> uploadModelExcel(
        ...
        Map<String, Object> result = pipeService.uploadModelExcel(machine_name, excelFile);
    ...
    public ResponseEntity<Map<String, Object>> tempExcel(
            @PathVariable String machine_name) {
        Map<String, Object> result = pipeService.downloadTemplateExcel(machine_name);
    ...
    public ResponseEntity<Map<String, Object>> uploadModelZip(
        ...
        Map<String, Object> result = pipeService.uploadModelZip(machine_name, allFile);
    ...
    public ResponseEntity<Map<String, Object>> updatePipe(
        ...
        result = pipeService.updatePipe(id, updateParamsJson, dtdModelFile, thumbnailFile, revitModelFile, symbolFile);
    ...
    public ResponseEntity<Map<String, Object>> deletePipe(
            @PathVariable String id,
            @RequestBody Map<String, Object> deleteParams) {
        Map<String, Object> result = pipeService.deletePipe(id, deleteParams);
    ...
    public ResponseEntity<Map<String, Object>> getDetailFiles(
        ...
        Map<String, Object> result = pipeService.getDetailFiles(equipment_id, fileParams);
    ...
    public ResponseEntity<Map<String, Object>> getDetailCommon(
        ...
        Map<String, Object> result = pipeService.getDetailCommon(equipment_type);
    ...
    public ResponseEntity<Map<String, Object>> searchPipeFormula(@RequestBody Map<String, Object> searchParams) {
        ...
        Map<String, Object> result = pipeService.getFormulaByEquipmentType(equipmentType);
    ...
    public ResponseEntity<Map<String, Object>> createPipeFormula(
            @RequestParam(value = "python_file") MultipartFile pythonFile,
            @RequestParam(value = "formula_id", required = false) String formulaId) {
        Map<String, Object> result = pipeService.createPipeFormula(pythonFile, formulaId);
    ...
    public ResponseEntity<Map<String, Object>> deletePipeFormula(@PathVariable String id) {
        Map<String, Object> result = pipeService.deletePipeFormula(id);
    ...
    public ResponseEntity<Map<String, Object>> createEquipmentPriceHistory(
        ...
        Map<String, Object> result = pipeService.createEquipmentPriceHistory(priceParams);
