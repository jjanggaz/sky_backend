...
public class MeasurementService {
     ...
     * 파이프 목록 조회 - 외부 API 호출
     */
    public Map<String, Object> getMeasurementList(Map<String, Object> searchParams, String waiLang) {
        logger.debug("외부 인증 서버 파이프 목록 조회 시도: server={}, params={}, waiLang={}", authServerBaseUrl, searchParams,
                waiLang);
        Map<String, Object> result = new HashMap<>();

        // 외부 인증 서버 URL 구성
        String measurementUrl = authServerBaseUrl + "/api/v1/equipment/equipment_catalog/search"
                + "?enable_dynamic_search=true"
                + "&include_hierarchy=true";
        logger.debug("파이프 목록 조회 URL: {}", measurementUrl);

        // 요청 본문 구성 - 화면에서 받은 파라미터 사용
        Map<String, Object> requestMap = new HashMap<>();

        // 기본값 설정
        requestMap.put("top_root_level", searchParams.getOrDefault("top_root_level", "INSTRMT"));
        ...
        HttpUtil.HttpResult httpResult = HttpUtil.post(measurementUrl, "application/json", requestBody);
     ...
     */
    public Map<String, Object> deleteMeasurement(String equipmentId, Map<String, Object> deleteParams) {
     ...
     * 파이프 업데이트
     */
    public Map<String, Object> updateMeasurement(String equipmentId, String updateParamsJson,
        ...
        try {
            ...
            if ((Boolean) updateResult.get("success")) {
                logger.debug("파이프 업데이트 완료: equipmentId={}", equipmentId);
            } else {
     ...
     * @return 업로드 결과
     */
    public Map<String, Object> createMeasurementFormula(MultipartFile pythonFile, String formulaId) {
     ...
     * @return 삭제 결과
     */
    public Map<String, Object> deleteMeasurementFormula(String formulaId) {
